...
<tr>
<td colspan="2" align="center"><img src="assets/img/time_to_lock.png" width="420" alt="Time from visit start to lock scatter and line chart"></td>
</tr>
<tr>
<td colspan="2" align="center"><sub>§3.3 — time to lock, window function <code>AVG() OVER (PARTITION BY)</code></sub></td>
</tr>
<tr>
<td colspan="2" align="center"><img src="assets/img/pathology_prevalence.png" width="420" alt="Pathology prevalence bar chart"></td>
</tr>
<tr>
<td colspan="2" align="center"><sub>§3.4 — pathology prevalence among locked first visits</sub></td>
</tr>
<tr>
<td colspan="2" align="center"><img src="assets/img/client_visit_summary.png" width="420" alt="Client visit summary scatter chart"></td>
</tr>
<tr>
<td colspan="2" align="center"><sub>§3.5 — headline <code>v_client_visit_summary</code> view, completion % vs. clinical risk</sub></td>
</tr>
</table>
...
| `16_timeToLock.ipynb` | Days from visit start to lock for locked first visits, vs. the rolling monthly average via `AVG() OVER (PARTITION BY)` (query 3.3) |
| `17_pathologyPrevalence.ipynb` | Pathology/risk flag prevalence among locked first visits, cross-referenced from `diagnostic_notes_history` (query 3.4) |
| `18_clientVisitSummary.ipynb` | Headline query against the `v_client_visit_summary` view — completion % vs. clinical risk flags (query 3.5) |
...
2. **Payments & revenue** — monthly revenue trends, payment status funnel,
   ...
   transaction
3. **First-visit** — per-client completion %, drop-off by section,
   time-to-lock, pathology prevalence, and a headline
   `v_client_visit_summary` view (all five queries implemented, §3.1–§3.5)
